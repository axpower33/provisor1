...
namespace WindowsFormsApp8
{
    public partial class Form16 : Form
    {
        ...
        {
            string _selectQuery = @"SELECT TableTableChast.Id, Nomenklatura.Naimenovanie as Nomenklatura, Edizm.Naimenovanie as EdIzm, Kolichestvo, Cena, Summa, UID FROM TableTableChast left join EdIzm on EdIzm.Id=EdIzm left join Nomenklatura on Nomenklatura.Id=Nomenklatura where TableTableChast.Id=" + pId1+" ORDER BY UID";
            string _selectQuery2 = @"Select DataDoc, NomerDoc, Kontragent.Naimenovanie as Kontragent, TableDoc.Id from TableDoc left join Kontragent ON Kontragent.Id = Kontragent where TableDoc.Id=" + pId1;
